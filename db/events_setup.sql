-- ============================================================
-- EVENT BOOKING — run this in phpMyAdmin after admin_setup.sql
-- ============================================================
...
(
    ...
    'Basic hall décor & lighting|Veg buffet (5 items)|Welcome drinks|Dedicated event staff|6 hours slot|Basic sound system',
    1
),
(
    'Gold',
...
(
    ...
    'Luxury mandap / stage setup|Full veg + non-veg menu (15+ items)|DJ + professional lighting|Photography & videography|Bridal suite with green room|Valet parking|Full day 12 hours slot|Dedicated wedding planner',
    3
);
