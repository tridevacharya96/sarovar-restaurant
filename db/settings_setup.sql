...
-- General
('restaurant_name',     'Sarovar Restaurant',                                   'Restaurant Name',       'general'),
('tagline',             'Experience the finest flavors of India in the heart of Rourkela', 'Hero Tagline', 'general'),
('about_text_1',        'Nestled in the vibrant city of Rourkela, Sarovar Restaurant has been a beacon of authentic Indian cuisine for over 15 years. Founded with a passion for preserving traditional recipes while embracing modern culinary techniques, we have become the go-to destination for food lovers across Odisha.', 'About Paragraph 1', 'general'),
('about_text_2',        'Our master chefs bring decades of experience, crafting each dish with the finest locally sourced ingredients. From aromatic biryanis to rich curries and delectable desserts, every meal at Sarovar is a celebration of flavors.', 'About Paragraph 2', 'general'),
...
-- SEO
('meta_description',    'Sarovar Restaurant – Authentic Indian cuisine in Rourkela. Order online, book a table or hall for your events.', 'Meta Description', 'seo'),
